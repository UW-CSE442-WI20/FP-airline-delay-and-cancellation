      ...
      flightList.forEach(function (d) {
        if (d.Airline == airline) {
          ...
          if (d['Flight Cancellation'] == 1) {
            if (d['Cancellation Reason'] == 'Airline') carrier++;
            if (d['Cancellation Reason'] == 'Weather') weather++;
            if (d['Cancellation Reason'] == 'National Air System') nationalAir++;
...
},{"d3":"UzF0","fuzzysort":"GlPB"}]},{},["Focm"], null)
//# sourceMappingURL=https://uw-cse442-wi20.github.io/FP-airline-delay-and-cancellation/src.53dc2075.js.map